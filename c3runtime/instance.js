"use strict";
{
     ...
     */
    class TextEditorRuntimeInstance extends globalThis.C3.SDKDOMInstanceBase {
        /**
         * @desc Create class.
        ...
        _OnTextChange(text, textHTML) {
            ...
            this._trigger(globalThis.C3.Plugins.RobotKaposzta_TextEditor.Cnds.OnTextChanged);
        }
    ...
    globalThis.C3.Plugins.RobotKaposzta_TextEditor.Instance = TextEditorRuntimeInstance;
};