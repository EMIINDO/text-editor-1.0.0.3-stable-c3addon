"use strict";
{
     ...
     */
    class TextEditorRuntimeDOMElementHandler extends globalThis.DOMElementHandler {
        /**
         * @desc Create class.
        ...
        CreateElement(elementId, e) {
            ...
            this._editor = new globalThis["Quill"](elem3, {
                "modules": {
                    "toolbar": [
                        [{
    ...
    globalThis.RuntimeInterface.AddDOMHandlerClass(TextEditorRuntimeDOMElementHandler);
}